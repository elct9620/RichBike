...
ActiveRecord::Schema.define(version: 2020_05_23_094613) do
  ...
  create_table "room_events", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_room_events_on_user_id"
  end
  ...
  add_foreign_key "room_events", "users"
